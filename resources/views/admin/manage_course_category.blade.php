...
@section('content')
    ...
    <div class="shadow-md rounded-lg p-6 flex flex-col gap-2">
        ...
        <div class="flex flex-col md:flex-row flex-nowrap overflow-auto gap-5">
            ...
            <div class="w-full">
                <div class="flex justify-end mb-2">
                    <button type="button"  data-modalid="modal-add-course-category" class="openModalBtn flex justify-center rounded-md bg-indigo-600 px-3 pb-1 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">+</button>
                </div>
